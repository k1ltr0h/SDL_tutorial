...
void GameObject::move(int dir){
    ...
    //if((dir == dir::RIGHT && orientation == dir::LEFT && vel.get_x() > 0) || 
    //(dir == dir::LEFT && orientation == dir::RIGHT && vel.get_x() < 0)){
...
void GameObject::flip_surface(bool axis){
...
Vector2D GameObject::get_velocity(int t){
    ...
    //if((vel.get_x() > 0 && x < 0) || (vel.get_x() < 0 && x > 0)){
    //    horizontal_flip = true;
    //}
...
bool GameObject::get_horizontal_flip(){
    return horizontal_flip;
}

bool GameObject::get_vertical_flip(){
...
void GameObject::set_horizontal_flip(bool horizontal_flip_){
